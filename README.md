...
__author__：我的CSDN博客地址：[Antrn](https://blog.csdn.net/qq_38232598/article/details/121520894?ops_request_misc=%257B%2522request%255Fid%2522%253A%2522165612168916782395311872%2522%252C%2522scm%2522%253A%252220140713.130102334.pc%255Fblog.%2522%257D&request_id=165612168916782395311872&biz_id=0&utm_medium=distribute.pc_search_result.none-task-blog-2~blog~first_rank_ecpm_v1~rank_v31_ecpm-1-121520894-null-null.nonecase&utm_term=http&spm=1018.2226.3001.4450) 
...
## 版本更新记录
 ...
 - 0.3.9.支持删除远程文件
 - 0.4.0.解决各种中文字符编码问题
 - 0.5.4.解决无法删除内层文件的bug
 - 0.5.6.解决上传文件夹内层文件内容丢失的bug
 - 0.5.8.增加删除空目录的功能
